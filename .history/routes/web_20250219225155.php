...
// Đặt các route có parameter xuống sau
Route::get('/doctor/{id}', [DoctorController::class, 'profile'])->name('doctor.profile.id');
...
Route::put('/appointments/{id}/approve', [DoctorController::class, 'approveAppointment'])
