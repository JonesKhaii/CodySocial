...
Route::put('/appointments/{id}/reject', [DoctorController::class, 'rejectAppointment'])->name('appointments.reject');
Route::put('/appointments/{id}/complete', [DoctorController::class, 'completeAppointment'])->name('appointments.complete');
Route::put('/appointments/{id}/cancel', [DoctorController::class, 'cancelAppointment'])->name('appointments.cancel');
// Route::middleware(['auth:doctor'])->group(function () {
//     Route::get('/doctor/appointments', [DoctorController::class, 'getAppointments'])->name('doctor.appointments');
// });
// Route::middleware(['auth:doctor'])->group(function () {
