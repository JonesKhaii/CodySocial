...
Route::put('/appointments/{id}/reject', [AppointmentController::class, 'rejectAppointment'])->name('appointments.reject');
Route::put('/appointments/{id}/complete', [AppointmentController::class, 'completeAppointment'])->name('appointments.complete');
Route::put('/appointments/{id}/cancel', [AppointmentController::class, 'cancelAppointment'])->name('appointments.cancel');
// Route::middleware(['auth:doctor'])->group(function () {
//     Route::get('/doctor/appointments', [DoctorController::class, 'getAppointments'])->name('doctor.appointments');
// });
// Route::middleware(['auth:doctor'])->group(function () {
//     Route::get('/doctor/appointments', function () {
//         dd("Laravel đã vào route này!");
...
Route::patch('/appointments/{id}/reject', [AppointmentController::class, 'rejectAppointment'])->name('appointments.reject');
Route::patch('/appointments/{id}/complete', [AppointmentController::class, 'completeAppointment'])->name('appointments.complete');
