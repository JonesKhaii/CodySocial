...
//Appointment
Route::patch('/appointments/{id}/approve', [AppointmentsController::class, 'approveAppointment'])->name('appointments.approve');
Route::patch('/appointments/{id}/reject', [AppointmentsController::class, 'rejectAppointment'])->name('appointments.reject');
Route::patch('/appointments/{id}/complete', [AppointmentsController::class, 'completeAppointment'])->name('appointments.complete');
Route::patch('/appointments/{id}/cancel', [AppointmentsController::class, 'cancelAppointment'])->name('appointments.cancel');
