...
function loadArticles(clearArticles, w_width) {
    ...
    $.getJSON("asset/js/articles.json", function (data) {
        let startIndex = (countArticles - 1) * 6; // Mỗi lần nhấn "Tải thêm", lấy tiếp 6 bài mới
        ...
        // Hiển thị hoặc ẩn nút "Tải thêm bài viết" và "Thu gọn bài viết"
        ...
        if (countArticles > 1) {
            $("#CollapseArticles").show(); // Hiển thị nút "Thu gọn" nếu có nhiều bài viết
        }
    }).fail(function () {
