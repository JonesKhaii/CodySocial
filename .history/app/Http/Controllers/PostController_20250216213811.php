...
class PostController extends Controller
{
    ...
    {
        $posts = Post::with('cat_info')->orderBy('id', 'DESC')->get();
        $categories = PostCategory::all(); // 🛠 Lấy danh mục ngay khi trang load

        return view('doctor.profile', compact('posts', 'categories'));
    }
