                                                    ...
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="comment-body flex-grow-1">
                                                            <div class="comment-meta mb-2">
                                                                <span
                                                                    class="comment-author fw-bold d-block">{{ $comment->author_info->name ?? 'N/A' }}</span>
                                                                <span
                                                                    class="comment-date text-muted small">{{ $comment->created_at->format('d M, Y H:i') }}</span>
                                                            </div>
                                                            <p class="comment-text mb-2">{{ $comment->body }}</p>
                                                                ...
                                                                <div class="single-comment border-bottom mb-3 pb-3">
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <div class="comment-body flex-grow-1">
                                                                            <div class="comment-meta mb-2">
                                                                                <span
                                                                                    class="comment-author fw-bold d-block">{{ $reply->author_info->name ?? 'N/A' }}</span>
                                                                                <span
