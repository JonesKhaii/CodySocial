                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="comments border-top mt-4 px-4 pb-4 pt-4">
                                    <h3 class="comment-title h4 mb-4">Bình luận ({{ $comments->count() }})</h3>
                                    ...
                                    <div class="comment-list">
                                        @if ($post->comments->count() > 0)
                                                ...
                                                <div class="single-comment border-bottom mb-4 pb-4">
                                                    <div class="d-flex">
                                                        <div class="comment-avatar me-3">
                                                            <img src="{{ asset($comment->user->avatar ?? 'images/default-avatar.png') }}"
                                                        ...
                                                        <div class="comment-body flex-grow-1">
                                                            <div class="comment-meta mb-2">
                                                                <span
                                                                    class="comment-author fw-bold d-block">{{ $comment->user->name }}</span>
                                                                <span
                                                                    class="comment-date text-muted small">{{ $comment->created_at->format('d M, Y H:i') }}</span>
                                                            </div>
                                                        ...
                                                        <div class="comment-replies mt-3 ps-5">
                                                            @foreach ($comment->replies as $reply)
                                                                <div class="single-comment border-bottom mb-3 pb-3">
                                                                    <div class="d-flex">
                                                                        <div class="comment-avatar me-3">
                                                                            <img src="{{ asset($reply->user->avatar ?? 'images/default-avatar.png') }}"
                                                                        ...
                                                                        <div class="comment-body flex-grow-1">
                                                                            <div class="comment-meta mb-2">
                                                                                <span
                                                                                    class="comment-author fw-bold d-block">{{ $reply->user->name }}</span>
                                                                                <span
                                                                                    class="comment-date text-muted small">{{ $reply->created_at->format('d M, Y H:i') }}</span>
                                                                            </div>
                                            ...
                                            @endforeach
                                        @else
                                            <div class="no-comments bg-light rounded py-4 text-center">
                                                <i class="fa fa-comments-o fa-2x text-muted mb-2"></i>
                                                <p class="mb-0">Chưa có bình luận nào. Hãy là người đầu tiên bình luận!
                                                </p>
                                            </div>
                                        @endif
                                    </div>
                                        ...
                                        <div class="reply">
                                            ...
                                            <form action="{{ route('post-comment.store', $post->slug) }}" method="POST"
                                                ...
                                                <div class="form-group mb-3">
                                                    <label class="mb-2">Tin nhắn của bạn<span
                                                            class="text-danger">*</span></label>
                                                    <textarea name="comment" rows="5" class="form-control" placeholder="Nhập bình luận của bạn..."></textarea>
                            ...
                            <ul class="list-group list-group-flush">
                                @foreach ($categories as $cat)
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                        ...
                                        <span class="badge bg-primary rounded-pill">{{ $cat->post_count ?? 0 }}</span>
                                    </li>
                                @endforeach
                            </ul>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.btn-reply').on('click', function() {
                ...
                // Implement your reply form logic here
            });
        });
    </script>
@endpush
