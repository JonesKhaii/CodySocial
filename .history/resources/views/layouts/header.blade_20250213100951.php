            ...
            <ul class="navbar-nav ms-auto">
                ...
                @auth
                    ...
                    @elseif(Auth::user()->role == 'doctor')
                        <li class="nav-item"><a class="nav-link text-white" href="{{ route('') }}">Trang
                                Tổng Quan Bác Sĩ</a></li>
                    @else
                        <li class="nav-item"><a class="nav-link text-white" href="{{ route('u') }}">Hồ Sơ Người
                                Dùng</a></li>
                    @endif

                    {{-- Đăng xuất --}}
                    <li class="nav-item"><a class="nav-link text-white" href="{{ route('') }}">Đăng Xuất</a></li>
                @else
                    <li class="nav-item"><a class="nav-link text-white" href="{{ route('') }}">Đăng Nhập</a></li>
                    <li class="nav-item"><a class="nav-link text-white" href="{{ route('') }}">Đăng Ký</a>
                    </li>
                @endauth

                {{-- Đăng xuất --}}
                @auth
                    <li class="nav-item"><a class="nav-link text-white" href="{{ route('') }}">Đăng Xuất</a>
                    </li>
                @endauth
            </ul>
        </div>
