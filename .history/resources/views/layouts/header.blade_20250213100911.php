            ...
            <ul class="navbar-nav ms-auto">
                ...
                @auth
                    ...
                    @elseif(Auth::user()->role == 'doctor')
                        <li class="nav-item"><a class="nav-link text-white" href="{{ route('doctor.dashboard') }}">Trang
                    ...
                    {{-- Đăng xuất --}}
                    <li class="nav-item"><a class="nav-link text-white" href="{{ route('user.logout') }}">Đăng Xuất</a></li>
                @else
                    <li class="nav-item"><a class="nav-link text-white" href="{{ route('login.form') }}">Đăng Nhập</a></li>
                    <li class="nav-item"><a class="nav-link text-white" href="{{ route('register.form') }}">Đăng Ký</a>
                    </li>
                @endauth
