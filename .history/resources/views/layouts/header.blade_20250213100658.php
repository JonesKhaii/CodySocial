            ...
            <ul class="navbar-nav ms-auto">
                ...
                @auth
                    @if (Auth::user()->role == 'admin')
                        <li class="nav-item"><a class="nav-link text-white" href="{{ route('admin') }}">Trang Tổng Quan</a>
                        </li>
                    @elseif(Auth::user()->role == 'doctor')
                        <li class="nav-item"><a class="nav-link text-white" href="{{ route('doctor.profile') }}">Trang Tổng
                                Quan</a></li>
                    @else
                        <li class="nav-item"><a class="nav-link text-white" href="{{ route('user.profile') }}">Hồ Sơ</a>
                        </li>
                    @endif
                @else
                ...
                {{-- Đăng xuất --}}
                @auth
                    <li class="nav-item"><a class="nav-link text-white" href="{{ route('user.logout') }}">Đăng Xuất</a>
                    </li>
                @endauth
            </ul>
        </div>
