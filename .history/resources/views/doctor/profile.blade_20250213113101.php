...
@section('main-content')
    <div class="container-fluid">
        @include('layouts.notification') {{-- Nếu có thông báo liên quan đến trạng thái hoặc thông tin người dùng --}}

        <!-- Page Heading -->
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Trang của Người Dùng / Admin</h1>
        </div>
