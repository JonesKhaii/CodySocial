...
@section('main-content')
            ...
            <div class="content">
                <div class="tab-content">
                    ...
                    {{-- <div class="tab-pane" id="appointments">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    <button class="btn btn-light btn-sm me-2" title="Lọc lịch hẹn">
                                        <i class="fas fa-filter"></i>
                                    </button>
                                    <button class="btn btn-light btn-sm" title="Xuất lịch">
                            ...
                            <div class="card-body">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div>
                                                                    <div class="fw-medium">{{ $appointment->user->name }}
                                                                    </div>
                                                        ...
                                                        <td>
                                                            <div>{{ $appointment->date->format('d/m/Y') }}</div>
                                                            <div class="small text-muted">
                                                                {{ $appointment->time->format('H:i') }}</div>
                                                        </td>
                                                        <td>
                                                            ...
                                                            @else
                                                                <span class="badge bg-primary text-white">
                                                                    <i class="fas fa-hospital me-1"></i> Tại phòng khám
                                                                </span>
                                                            @endif
                                                        </td>
                                                        <td>
                                                            ...
                                                            @php
                                                                ...
                                                                $approval = $approvalMap[
                                                                    ...
                                                                    'text' => $appointment->approval_status,
                                                                    'class' => 'bg-secondary',
                                                                ];
                                                            @endphp
                                                            <div class="mt-1">
                                                                <span
                                                                    class="badge {{ $approval['class'] }}">{{ $approval['text'] }}</span>
                                                            </div>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <div class="btn-group">
                                                                ...
                                                                @if ($appointment->status === 'pending' && $appointment->approval_status === 'approved')
                                                                    <form
                                                                ...
                                                                <button type="button"
                                                                    ...
                                                                    title="Thêm ghi chú"
                                                                    onclick="showNoteModal({{ $appointment->id }})">
                                                                    <i class="fas fa-edit"></i>
                                                                </button>
                                                            </div>
                                                        </td>
                                ...
                                @else
                                    <div class="py-5 text-center">
                                        ...
                                        <p class="text-secondary mb-0">Bạn chưa có lịch hẹn nào được đặt</p>
                                    </div>
                                @endif
                            </div>
                        </div>
                    ...
                    <div class="tab-pane fade" id="appointments">
                        <div class="card">
                            <div class="card-header">
                                <h2 class="card-title">Lịch hẹn của bạn</h2>
                                <div class="card-header-actions">
                                    <button class="btn-icon" title="Lọc lịch hẹn">
                                        <i class="fas fa-filter"></i>
                                    </button>
                                    <button class="btn-icon" title="Xuất lịch">
                                        <i class="fas fa-download"></i>
                                    </button>
                                </div>
                            </div>
                            <div class="card-body">
                                        ...
                                        <table class="table">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Trạng thái</th> <!-- Status: Tình trạng của lịch khám -->
                                                    <th>Xác nhận</th> <!-- Approval Status: Hành động của bác sĩ -->
                                                    <th>Ghi chú</th>
                                                    <th>Hành động</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                @foreach ($appointments as $appointment)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <img src="{{ $appointment->user->photo ?? '/images/default-avatar.png' }}"
                                                                    alt="Patient"
                                                                    class="rounded-circle me-2"
                                                                    style="width: 32px; height: 32px; object-fit: cover;">
                                                                <div>
                                                                    <div class="fw-bold">{{ $appointment->user->name }}
                                                                    </div>
                                                                    <small
                                                                        class="text-muted">{{ $appointment->user->email }}</small>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <!-- Ngày hẹn -->
                                                        ...
                                                        <!-- Giờ hẹn -->
                                                        <td>{{ \Carbon\Carbon::parse($appointment->time)->format('H:i') }}
                                                        </td>
                                                        <!-- Hình thức khám -->
                                                        <td>
                                                            @switch($appointment->consultation_type)
                                                                @case('Online')
                                                                    <span class="badge bg-info"><i class="fas fa-video me-1"></i>
                                                                        Trực tuyến</span>
                                                                @break

                                                                @case('Offline')
                                                                    <span class="badge bg-primary"><i
                                                                            class="fas fa-hospital me-1"></i> Tại phòng khám</span>
                                                                @break

                                                                @case('At Home')
                                                                    <span class="badge bg-success"><i
                                                                            class="fas fa-home me-1"></i> Tại nhà</span>
                                                                @break
                                                            @endswitch
                                                        </td>
                                                        ...
                                                        <!-- Trạng thái xác nhận của bác sĩ (Approval Status) -->
                                                        <td>
                                                            @switch($appointment->approval_status)
                                                                @case('Chờ duyệt')
                                                                    <span class="badge bg-warning">Chờ duyệt</span>
                                                                @break
                                                        ...
                                                        <td>
                                                            <div class="btn-group">
                                                                ...
                                                                @if ($appointment->approval_status === 'Chờ duyệt')
                                                                    <form method="POST"
                                                                        action="{{ route('appointments.approve', ['id' => $appointment->id]) }}"
                                                                        class="d-inline">
                                                                        @csrf
                                                                        @method('PATCH')
                                                                        <button type="submit"
                                                                    ...
                                                                    <form method="POST"
                                                                        action="{{ route('appointments.reject', ['id' => $appointment->id]) }}"
                                                                        class="d-inline">
                                                                        @csrf
                                                                        @method('PATCH')
                                                                        <button type="submit"
                                                                ...
                                                                @if ($appointment->status === 'Sắp tới' && $appointment->approval_status === 'Chấp nhận')
                                                                    <form method="POST"
                                                                        action="{{ route('appointments.complete', ['id' => $appointment->id]) }}"
                                                                        class="d-inline">
                                                                        @csrf
                                                                        @method('PATCH')
                                                                        <button type="submit"
                                ...
                                @else
                                    <div class="py-5 text-center">
                                        <i class="fas fa-calendar-times fa-3x text-muted mb-3"></i>
                                        <h3 class="text-muted">Chưa có lịch hẹn nào</h3>
                                        <p class="text-secondary mb-4">Bạn chưa có lịch hẹn nào được đặt</p>
                                    </div>
                                @endif
                            </div>
                        </div>
                    ...
                    <!-- Sản phẩm tiếp thị -->
                    <div class="tab-pane fadefade" id="marketing-products">
                        <div class="card">
                            <div class="card-header">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            console.log("DOM đã tải xong, bắt đầu lắng nghe sự kiện.");
            ...
            navItems.forEach(item => {
                ...
                if (link.getAttribute('data-toggle') === 'tab') {
                    link.addEventListener('click', function(e) {
                        ...
                        // Loại bỏ 'active' từ tất cả các tab và menu
                        navItems.forEach(nav => nav.classList.remove('active'));
                        tabPanes.forEach(tab => tab.classList.remove("active", "show"));
            ...
            // 🔹 Hiển thị & đóng modal chỉnh sửa thông tin bác sĩ
            ...
            if (closeModal) closeModal.addEventListener('click', () => hideModal(editModal));
            if (cancelModal) cancelModal.addEventListener('click', () => hideModal(editModal));

            // 🔹 Hiển thị & đóng modal thêm bài viết
            ...
            if (closeAddPostModal) closeAddPostModal.addEventListener('click', () => hideModal(addPostModal));
            if (cancelAddPost) cancelAddPost.addEventListener('click', () => hideModal(addPostModal));

            // 🔹 Hiển thị & đóng modal chỉnh sửa bài viết
            ...
            if (closeEditPostModal) closeEditPostModal.addEventListener('click', () => hideModal(editPostModal));
            if (cancelEditPost) cancelEditPost.addEventListener('click', () => hideModal(editPostModal));
