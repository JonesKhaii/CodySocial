    ...
    <div id="edit-post-modal" class="modal">
        <div class="modal-content">
            ...
            <form id="edit-post-form" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <input type="hidden" id="edit-post-id" name="post_id" value="{{ $post->id }}">
                ...
                <div class="form-group">
                    ...
                    <textarea id="edit-summary" name="summary" class="form-control" required>{{ $post->summary }}</textarea>
                </div>
                <div class="form-group">
                    <label for="edit-description">Nội dung</label>
                    <textarea id="edit-description" name="description" class="form-control" required>{{ $post->description }}</textarea>
                </div>
                <div class="form-group">
                    ...
                    <select id="edit-post-cat-id" name="post_cat_id" class="form-control" required>
                        @foreach ($categories as $category)
                            <option value="{{ $category->id }}"
                                {{ $category->id == $post->post_cat_id ? 'selected' : '' }}>
                                {{ $category->title }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <br>
                    <img src="{{ $post->photo }}" alt="Ảnh bài viết" style="max-width: 200px; display: block;">
                </div>

                <!-- Input chọn ảnh mới (nếu có) -->
                <div class="form-group">
