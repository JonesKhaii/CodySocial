    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (categorySelect) {
                ...
                for (let i = 1; i < options.length; i++) { // Bỏ qua option "Chọn danh mục"
                    categoryList.push(`${options[i].value}: ${options[i].text}`);
                }

                console.log("🟢 Danh sách danh mục: ", categoryList.join(" | "));
            } else {
