            ...
            <div class="sidebar-wrapper">
                <ul class="nav">
                    <li class="nav-item active">
                        <aclass="nav-link" href="#info-personal" data-toggle="tab">
                    ...
                    <li class="nav-item">
                        <aclass="nav-link" href="#marketing-products" data-toggle="tab">
                        <i class="fas fa-shopping-cart"></i>
                        <p>Sản phẩm tiếp thị</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <aclass="nav-link" href="#income" data-toggle="tab">
            ...
            <div class="page-header">
                ...
                <ul class="breadcrumb">
                    <li class="breadcrumb-item">
                        <ahref="#" class="breadcrumb-link">Trang chủ</a>
                    </li>
