    ...
    <script>
        ...
        document.getElementById("photo").addEventListener("change", function(event) {
            ...
            fetch("{{ route('upload.image') }}", {
                ...
                .then(data => {
                    if (data.webp_url) {
                        // Lưu URL ảnh WebP vào input hidden
                        let inputHidden = document.createElement("input");
                        inputHidden.type = "hidden";
                        inputHidden.name = "image_url";
                        inputHidden.value = data.webp_url;
                        document.getElementById("add-post-form").appendChild(inputHidden);
                    }
                })
