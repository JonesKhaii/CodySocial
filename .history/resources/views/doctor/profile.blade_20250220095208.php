            ...
            <div class="sidebar-wrapper">
                <ul class="nav">
                    <li class="nav-item active">
                        <a class="nav-link" href="#info-personal" data-bs-toggle="tab">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#marketing-products" data-bs-toggle="tab">
                            <i class="fas fa-shopping-cart"></i>
                            <p>Sản phẩm tiếp thị</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#financial-stats" data-bs-toggle="submenu">
                        ...
                        <ul class="submenu nav">
                            <li class="nav-item">
                                <a class="nav-link" href="#income" data-bs-toggle="tab">
