...
@section('main-content')
    ...
    <style>
        ...
        .main-panel {
            margin-left: 250px;
            /* Để phần content không bị chồng lên sidebar */
            padding: 20px;
            overflow-y: auto;
            width: 100%;
            /* Đảm bảo rằng chiều rộng sẽ co lại theo màn hình */
        }
                        ...
                        <div class="tab-pane active" id="info-personal">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p><strong>Anhr đại diện: <img src="{{ $doctor->photo }}" alt="Ảnh Bác Sĩ"
                                                class="img-thumbnail"
