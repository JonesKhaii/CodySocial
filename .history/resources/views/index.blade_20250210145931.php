                ...
                <div class="row">
                    @foreach ($posts as $post)
                        <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <div class="card article-card mb-4 border-0 shadow-sm">
                                    <img src="{{ asset($post->photo) }}" class="card-img-top rounded-top"
                                        alt="{{ $post->title }}">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text text-truncate"
                                            style="max-width: 100%; max-height: 3rem; overflow: hidden;">
                                            {{ Str::limit(strip_tags($post->summary), 100, '...') }}
                                        </p>
                                        <p class="card-text">
                                            <small class="text-muted">
                                                <i class="fas fa-user"></i> {{ $post->author_info->name ?? 'Ẩn danh' }}
                                                | <i class="fas fa-calendar-alt"></i>
                                                {{ $post->created_at->format('d/m/Y') }}
                                            </small>
                                        </p>
