                ...
                <div class="modal-body">
                    <form action="{{ route('user.book.appointment') }}" method="POST" id="appointmentForm">
                        ...
                        <div class="row g-3">
                            <!-- Tìm kiếm bác sĩ -->
                            <div class="col-md-6">
                                <label class="form-label">Nhập tên bác sĩ</label>
                                <input type="text" id="doctor_search" class="form-control"
...
@push('scripts')
    <script>
        ...
        $(document).ready(function() {
                    // Autocomplete tìm kiếm bác sĩ
                    $("#doctor_search").autocomplete({
                        source: function(request, response) {
                            $.ajax({
                                url: "{{ route('api.search.doctors') }}", // API tìm kiếm bác sĩ
                                data: {
                                    term: request.term
                                },
                                dataType: "json",
                    ...
                    document.querySelector('select[name="doctor_id"], input[name="date"]').addEventListener('change',
                        function() {
