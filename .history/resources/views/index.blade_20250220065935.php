    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function filterPosts() {
                const selectedCategory = categoryFilter.value.trim(); // Lấy giá trị tên danh mục
                const searchTerm = searchInput.value.toLowerCase().trim();

                posts.forEach(post => {
                    const postCategory = post.getAttribute('data-category')
                .trim(); // Lấy tên danh mục từ bài viết
                    const postContent = post.textContent.toLowerCase();

                    // Kiểm tra bài viết có thuộc danh mục đã chọn không
                    const matchesCategory = selectedCategory === '' || postCategory === selectedCategory;

                    // Kiểm tra nội dung bài viết có chứa từ khóa tìm kiếm không
                    const matchesSearch = searchTerm === '' || postContent.includes(searchTerm);

                    // Hiển thị hoặc ẩn bài viết dựa trên điều kiện lọc
            ...
            // Debug Log để kiểm tra giá trị category filter
            categoryFilter.addEventListener('change', function() {
                console.log('Selected category title:', this.value);
            });
        });
    </script>
@endsection
